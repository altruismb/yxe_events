...
<head>
  ...
  <title>Add Event - YXEEVENTS</title>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="a_addstyles.php">
              <i class="fa fa-map"></i> Target Group
            </a>
          </li>
          <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          ...
          <div class="row">
            <div class="col-12">
              <h2 class="tm-block-title d-inline-block">Add Event </h2>
            </div>
          </div>
          ...
          <div class="row tm-edit-product-row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
              ...
              <form action="../actions/add_plan.php" method="POST" enctype="multipart/form-data" class="tm-edit-product-form">
                ...
                <div class="form-group mb-3">
                  <label for="description" name="pdescr">Event Description</label>
                  <input id="name" name="pdescr" type="text" class="form-control validate" rows="3" required />
                </div>
                <div class="form-group mb-3"> <label for="category">Event Category</label>
                ...
                <div class="form-group mb-3"> <label for="style">Target Group</label>
                ...
                <div class="row">
                  <div class="form-group mb-3 col-xs-12 col-sm-6">
                    <label for="expire_date">Event Price (CAD) 
                    </label>
                    <input id="expire_date" name="pprice" type="number" min="0" class="form-control validate" data-large-mode="true" />
                  </div>
                  <div class="form-group mb-3 col-xs-12 col-sm-6">
                    <label for="stock">Date
                    </label>
                    <input id="stock" name="pkey" type="date" class="form-control validate" required />
                  </div>
                </div>
            ...
            <div class="col-12">
              <button type="submit" name="add_product" class="btn btn-primary btn-block text-uppercase">Add Event</button>
            </div>
            </form>
          </div>
        </div>
