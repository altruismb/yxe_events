...
<html lang="en">
  <head>
    ...
    <title>Add Categories - YXEEVENTS</title>
    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
          ...
          <div class="row">
            <div class="d-flex justify-content-center">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">Add Event Category</h2>
                  </div>
                </div>
        ...
        <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                ...
                <center><h2 class="tm-block-title">Event Categories</h2></center>
