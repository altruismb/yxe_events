      ...
      <div class="row">
        <div class="col-sm-12">
          <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
            ...
            <img src="<?php echo htmlspecialchars($product_one['plan_image'], ENT_QUOTES, 'UTF-8'); ?>" alt="">
            </div>
          </div>
              ...
              <div class="property-price d-flex justify-content-center foo">
                <div class="card-header-c d-flex">
                  ...
                  <div class="card-title-c align-self-center">
                    <h5 class="title-c">
                    <?php echo htmlspecialchars($product_one['plan_price'], ENT_QUOTES, 'UTF-8'); ?>
                    </h5>
                  </div>
                </div>
              </div>
                ...
                <div class="summary-list">
                  <ul class="list">
                    ...
                    <li class="d-flex justify-content-between">
                      ...
                      <span>
                      <?php echo htmlspecialchars($product_one['plan_keywords'], ENT_QUOTES, 'UTF-8'); ?>
                      </span>
                    </li>
                    <li class="d-flex justify-content-between">
