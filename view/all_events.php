      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src=<?php echo $showplan['plan_image']?> alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="#"><?php echo $showplan['plan_title'] ?></a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Price | <?php echo $showplan['plan_price'] ?> </span>
                  </div>
                  <a href="single_event.php?id=<?php echo $showplan['plan_id']; ?>" class="link-a">Click here to view
